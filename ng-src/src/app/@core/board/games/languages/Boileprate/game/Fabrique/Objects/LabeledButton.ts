import { Label } from './Label';
    ...
    export class LabeledButton extends Phaser.Button {
        ...
        constructor(game: Phaser.Game, x: number, y: number, text: string, textStyle: any,
            callback: Function, callbackContext: any, maxWidth?: number, maxHeight?: number) {
        ...
        public createTexture(bgColor: number): void {
            ...
            const graphics: Phaser.Graphics = this.game.make.graphics(0, 0);
            graphics.beginFill(0x000000, 0.3)
                .drawRoundedRect(5,
                    5 * Constants.GAME_SCALE, this.maxWidth - 10 * Constants.GAME_SCALE, this.maxHeight, 15 * Constants.GAME_SCALE)
                .beginFill(bgColor)
